...
- High defects open: <n>
- Release decision: <pass | blocked | conditional with named approval>

## Results
| Test ID | Requirement/JTBD | Result | Evidence | Defect |
|---|---|---|---|---|

## Defects
| ID | Severity | Reproduction | Owner | Status | Retest evidence |
|---|---|---|---|---|---|

## Decision notes
- <approved exceptions, blocked integrations, residual risks>

## Next edits
1. <NPAO-ranked change>
```
