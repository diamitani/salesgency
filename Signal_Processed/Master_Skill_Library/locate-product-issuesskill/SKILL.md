---
name: locate-product-issuesskill
description: Process/Note derived from locate-product-issues.SKILL.md
source_path: figmasentinel/locate-product-issues.SKILL.md
---

# locate-product-issues.SKILL.md

## Context
This skill provides knowledge, processes, and instructions derived from the document: `locate-product-issues.SKILL.md`.
