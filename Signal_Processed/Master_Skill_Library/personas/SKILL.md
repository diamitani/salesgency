---
name: personas
description: Process/Note derived from personas.md
source_path: pop-skill-main/scopes/personas.md
---

# personas.md

## Context
This skill provides knowledge, processes, and instructions derived from the document: `personas.md`.
