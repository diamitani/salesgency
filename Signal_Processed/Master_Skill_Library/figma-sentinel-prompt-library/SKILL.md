---
name: figma-sentinel-prompt-library
description: Process/Note derived from figma-sentinel-prompt-library.md
source_path: figmasentinel/figma-sentinel-prompt-library.md
---

# figma-sentinel-prompt-library.md

## Context
This skill provides knowledge, processes, and instructions derived from the document: `figma-sentinel-prompt-library.md`.
