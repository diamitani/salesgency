---
name: patrick-diamitani-portfolio-full
description: Process/Note derived from Patrick-Diamitani-Portfolio-FULL.pdf
source_path: Atlas Portfolio/Portfolio/Patrick-Diamitani-Portfolio-FULL.pdf
---

# Patrick-Diamitani-Portfolio-FULL.pdf

## Context
This skill provides knowledge, processes, and instructions derived from the document: `Patrick-Diamitani-Portfolio-FULL.pdf`.
...
FULL EDITION · JULY 2026

A I & A U T O M AT I O N · G T M S Y S T E M S E N G I N E E R I N G

Patrick Diamitani
GTM AI & Automation Manager · AI & Automation lead at Atlas HXM.
...
Reps advanced deals to contracting & KYC without knowing if
the role or industry was even eligible for EOR. Compliance only
caught blockers at contract review — after the prospect was
ready to sign. Lost deals, wasted KYC, eroded trust.
WHAT I BUILT
...
detection (Tier 3 caught up from
7 → 15, all traceable to a named
worksheet trigger).
• 16 unit tests + full dry-run
validation + 238/238 clean
production writes before go-live.
...
writing. The automation that was supposed to do it was failing
21 of 25 recent runs — a dead vector-search index left four AI
agents with no country context.
WHAT I BUILT
...
• Cut context bloat from 20
countries / 882KB to intent-only
6 countries / 295KB per call —
cheaper and higher signal.
• Restored specific, grounded
output (real severance formulas,
social-security rates) over
generic filler.
...
against a clear definition-ofready (webhooks fire cleanly, AI
uses only factual data — no
hallucinations).
...
The chatbot (an AI customer agent) was capturing
conversations, but the attribution flag was never being stamped
— so 364 chatbot contacts going back years were invisible to
every report and list. The channel looked dead when it wasn't.
WHAT I BUILT
...
in all reporting.
• Idempotent MQL classification →
routing → rep notification
...
• JSON is deploy-ready; owner ID
patched, association bug fixed,
error workflow wired. Blocked
only on four CRM properties + a
partner-form change on another
owner's track.
...
could legally hire in. Marketing pays for country-specific search
ads and didn't want to keep bidding on a country it could no
longer serve — or miss one that just opened.
WHAT I BUILT
...
workflow delivered; routed to VP
Growth + reviewer for sign-off
per the approval gate. Phase-2
agency feed built but held
pending format spec.
...
compliance-screened lists — without contacting existing
customers, open deals, closed-lost, or recently-touched
contacts.
WHAT I BUILT
...
• 5,398-contact master activated;
weekly batches tagged by
segment for agency-level
reporting.
• Every list screened live against
the CRM — 4 companies pulled
for open-deal/closed-lost, 20
contacts removed for activesequence/recent-touch before
send.
...
“Copy of” tables, phone numbers were bought 2–3x per contact,
and people-searches ran with no ICP gate.
WHAT I BUILT
...
of Excellence: consistent PRDs,
architecture, and build plans
across every GTM initiative.
...
Patrick Diamitani
GTM AI & Automation Manager · Atlas HXM · Chicago, IL
pdiamitani@atlashxm.com · linkedin.com/in/diamitani
Every metric and technical detail on this page is drawn from real, shipped project records. Full edition — shared under NDA /
for direct evaluation. No secrets, keys, tokens, or endpoints are reproduced anywhere in this document.
