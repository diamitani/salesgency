---
name: gtm
description: Process/Note derived from gtm.md
source_path: n8n-engineer/references/gtm.md
---

# gtm.md

## Context
This skill provides knowledge, processes, and instructions derived from the document: `gtm.md`.
