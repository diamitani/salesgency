---
name: prospect-automation---part-1-1-1
description: Process/Note derived from PROSPECT AUTOMATION - PART 1 (1) (1).json
source_path: PROSPECT AUTOMATION - PART 1 (1) (1).json
---

# PROSPECT AUTOMATION - PART 1 (1) (1).json

## Context
This skill provides knowledge, processes, and instructions derived from the document: `PROSPECT AUTOMATION - PART 1 (1) (1).json`.
Use this information to inform GTM strategies, sales playbooks, automation engine logic, and CRM setup.

## Knowledge Source

{
  "name": "PROSPECT AUTOMATION - PART 1",
  "nodes": [
    {
      "parameters": {
        "method": "POST",
      ...
      "id": "6af258ac-8c46-4772-bd16-f47c75d5d820",
    ...
    },
    {
      ...
      "id": "f8dd3456-1706-4de7-b653-f2074c3124b9",
    ...
    },
    {
      ...
      "id": "99f61bd9-23c4-4b58-8bca-0d75922cafaf",
    ...
    },
    {
      ...
      "id": "63cbc350-8633-413e-8454-58641cc1ea0f",
      "name": "Filter - type"
    },
    {
      "parameters": {
      ...
      "id": "aaa0ccc4-a046-4332-bc5a-2c74e705cc5b",
    ...
    },
    {
      ...
      "id": "da7f1886-bd99-493b-ac62-997cb22740ed",
    ...
    },
    {
      ...
      "id": "95364817-71b1-4cd3-a565-a07b212541b6",
      "name": "Edit Fields"
    },
    {
      "parameters": {
      ...
      "id": "697a1e87-9418-40ae-a863-2491087465cb",
    ...
    },
    {
      ...
      "id": "4bd0efc5-c480-420c-8b81-90ee696c49d0",
    ...
    },
    {
      ...
      "id": "5c71c0ae-032e-4f8d-8f41-78821b0c01ba",
    ...
    },
    {
      ...
      "id": "d43de673-c3c4-4f18-a800-2248291d9942",
    ...
    },
    {
      ...
      "id": "a8780960-89ac-42a6-b392-874a79280979",
    ...
    },
    {
      ...
      "id": "eb3c4f85-edfc-4ae9-8fcf-352d39428e70",
      "name": "ICP Filter - Schools & Governments"
    },
    {
      "parameters": {
        "method": "POST",
        "url": "https://api.clay.com/v3/sources/webhook/pull-in-data-from-a-webhook-045f9cc9-4aa5-4a0f-931b-e43d49755506",
        "sendBody": true,
        "specifyBody": "json",
      ...
      "id": "91fe7fb1-a06c-413f-ae5f-868f831aa384",
      "name": "HTTP Request",
      "retryOnFail": true,
    ...
    },
    {
      ...
      "id": "16893fff-6de7-47ca-a3ca-4840eb74999a",
    ...
    },
    {
      ...
      "id": "4c045f3b-f76f-4782-9c77-2753bc45ad9a",
  ...
  "versionId": "2e8ab869-b95b-458f-a250-5d3a3df0c7ad",
  "meta": {
